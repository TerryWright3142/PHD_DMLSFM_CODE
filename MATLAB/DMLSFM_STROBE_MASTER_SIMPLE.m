%DMLSFM_STROBE_MASTER_SIMPLE
%%%%%%% this is to be used with  DMLSFM_STROBE_SIMPLE.vi
%
...
disp('Initialise memory map which is used for IPC with the LabVIEW script DMLSFM_HCI_STROBE.vi');
delete('test.dat');
