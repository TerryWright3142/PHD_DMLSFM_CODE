function [err_message, is_ok_saturated_act_count, is_ok_camera_fill_pct, is_ok_pupil_size_variation, is_ok_dwf_pv] = Imop_LoopSecurity_CheckMedium(camera_fill_percentage, corrdata_manager, delta_slopes_pupil, current_corrector_positions, delta_commands)
...
if nargin ~= 5
	error('The "Imop_LoopSecurity_CheckMedium" function requires 5 input argument(s).');
end
err_message = char(ones(256,1,'int8'));

[err_nb, err_message, current_corrector_positions, delta_commands, is_ok_saturated_act_count, is_ok_camera_fill_pct, is_ok_pupil_size_variation, is_ok_dwf_pv] = calllib('WaveKitRuntime', 'Imop_LoopSecurity_CheckMedium', err_message, camera_fill_percentage, corrdata_manager, delta_slopes_pupil, current_corrector_positions, delta_commands, is_ok_saturated_act_count, is_ok_camera_fill_pct, is_ok_pupil_size_variation, is_ok_dwf_pv);
