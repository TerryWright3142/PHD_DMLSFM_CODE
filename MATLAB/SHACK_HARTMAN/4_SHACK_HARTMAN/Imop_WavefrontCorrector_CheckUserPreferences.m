function err_message = Imop_WavefrontCorrector_CheckUserPreferences(corrector, sleep_after_movement, min, max, validity, fixed_values)
...
if nargin ~= 6
	error('The "Imop_WavefrontCorrector_CheckUserPreferences" function requires 6 input argument(s).');
end
err_message = char(ones(256,1,'int8'));

[err_nb, err_message, min, max, validity, fixed_values] = calllib('WaveKitRuntime', 'Imop_WavefrontCorrector_CheckUserPreferences', err_message, corrector, sleep_after_movement, min, max, validity, fixed_values);
