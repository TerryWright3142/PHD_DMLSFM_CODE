function err_message = Imop_WavefrontCorrector_CheckActuatorUserPreferences(corrector, actuator_index, min, max, validity, fixed_value)
...
if nargin ~= 6
	error('The "Imop_WavefrontCorrector_CheckActuatorUserPreferences" function requires 6 input argument(s).');
end
err_message = char(ones(256,1,'int8'));

[err_nb, err_message] = calllib('WaveKitRuntime', 'Imop_WavefrontCorrector_CheckActuatorUserPreferences', err_message, corrector, actuator_index, min, max, validity, fixed_value);
