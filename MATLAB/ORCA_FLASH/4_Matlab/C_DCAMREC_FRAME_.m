...
classdef C_DCAMREC_FRAME_ < C_BASIC_TYPES
    properties    
iKind;
option;
iFrame;
...
camerastamp;
    ...
    methods 
        function obj = C_DCAMREC_FRAME_(iFrame, iKind, option,  ...
                buf, rowbytes, ...
                type, width, height, left, top, ...
                timestamp, framestamp, camerastamp ...
                )
            obj.size = 64;  %sizeof(DCAMREC_FRAME)
            obj.iFrame = iFrame;
            if nargin == 1
                obj.iKind = 0;
                obj.option = 0;
                ...
                obj.matlabPtr = libpointer('R_DCAMREC_FRAME_', pstruct);               
        end
